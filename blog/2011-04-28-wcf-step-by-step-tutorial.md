...
1. Open Visual Studio 2010 and File->NewProject 2.select WCF in 'Recent Templates' 3.select 'WCF Service Library' 4.Give Name as wcfMathServiceLibrary 5.Click OK
...
2. Go to ‘Solution Explorer’ Right click on ConsoleMathClient -> Select ‘Add Service Reference’ the below dialog will be displayed
3. Click on Discover button
4. Give namespace as ‘MathServiceReference’ and click OK
