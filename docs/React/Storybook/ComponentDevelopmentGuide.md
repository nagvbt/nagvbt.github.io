...
- [Prerequisites](/docs/React/Storybook/ComponentDevelopmentGuide#prerequisites)
- [Steps to Create a Sample Component](/docs/React/Storybook/ComponentDevelopmentGuide#steps-to-create-a-sample-component)
  - [Component Logic](/docs/React/Storybook/ComponentDevelopmentGuide#component-logic)
    - [IconButton.jsx](/docs/React/Storybook/ComponentDevelopmentGuide#iconbuttonjsx)
    - [Do this](/docs/React/Storybook/ComponentDevelopmentGuide#do-this)
    - [Do not do this](/docs/React/Storybook/ComponentDevelopmentGuide#do-not-do-this)
    - [Styled-Components](/docs/React/Storybook/ComponentDevelopmentGuide#styled-components)
    - [Documentation](/docs/React/Storybook/ComponentDevelopmentGuide#documentation)
  - [Story](/docs/React/Storybook/ComponentDevelopmentGuide#story)
    - [IconButton.stories.jsx](/docs/React/Storybook/ComponentDevelopmentGuide#iconbuttonstoriesjsx)
    - [Do this](/docs/React/Storybook/ComponentDevelopmentGuide#do-this-1)
    - [AddOn:](/docs/React/Storybook/ComponentDevelopmentGuide#addon-)
      - [1. Controls](/docs/React/Storybook/ComponentDevelopmentGuide#1-controls)
      - [2. Actions](/docs/React/Storybook/ComponentDevelopmentGuide#2-actions)
      - [3. Accessibility](/docs/React/Storybook/ComponentDevelopmentGuide#3-accessibility)
      - [4. Story](/docs/React/Storybook/ComponentDevelopmentGuide#4-story)
      - [5. CSS resources](/docs/React/Storybook/ComponentDevelopmentGuide#5-css-resources)
      - [6. RTL support](/docs/React/Storybook/ComponentDevelopmentGuide#6-rtl-support)
  - [Unit Testing](/docs/React/Storybook/ComponentDevelopmentGuide#unit-testing)
    - [Do this](/docs/React/Storybook/ComponentDevelopmentGuide#do-this-2)
    - [IconButton.test.jsx](/docs/React/Storybook/ComponentDevelopmentGuide#iconbuttontestjsx)
