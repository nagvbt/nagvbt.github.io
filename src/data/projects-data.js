...
const projects = [
  {
    ...
    description: (
      <>
        <p>
          nag-rlib is an component library which is a collection of logically
          group components so that one can explore, select components and helps
          in maintaining consistent design across projects. nag-rlib built using
          following components. create-react-library Storybook
    ...
    links: [
      {
        ...
        link: "https://github.com/nagvbt/nag-rlib",
      },
    ],
  },
  {
